...
export default function StudentCreatePage() {
    ...
    async function fetchAluno() {
      try {
        ...
        setFormState({
          ...
          guardianSurname:
            data.nomeResponsavel?.split(" ").slice(1).join(" ") ?? "",
  ...
  const validate = () => {
    ...
    if (!formState.addressComplement.trim())
      nextErrors.addressComplement = "Informe o complemento.";
    ...
    if (!formState.guardianEmail.trim())
      ...
      nextErrors.guardianEmail = "Informe um e-mail válido.";
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      nomeResponsavel:
        `${formState.guardianName} ${formState.guardianSurname}`.trim(),
    ...
    try {
      ...
      alert(
        isEditing ? "Erro ao atualizar aluno." : "Erro ao cadastrar aluno.",
      );
    } finally {
    ...
    <div className="managementPageLayout">
      ...
      <div className="managementMain">
        ...
        <main className="managementContent">
          <section
            className="student-create-page__card"
            aria-label="Formulario de cadastro de aluno"
          >
            ...
            >
              ...
              <FormField
                ...
                onChange={(e) =>
                  handleFieldChange("guardianSurname", e.target.value)
                }
              ...
              <FormField
                ...
                onChange={(e) =>
                  handleFieldChange("guardianPhone", e.target.value)
                }
